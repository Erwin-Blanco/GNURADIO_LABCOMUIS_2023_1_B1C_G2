...
from Modulador_AM_Erwin import Modulador_AM_Erwin  # grc-generated hier_block
...
class generador_amplitud_GNU_radio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "modulador_AM_GNU_radio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulador_AM_GNU_radio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "generador_amplitud_GNU_radio")
        ...
        self._ka_win = RangeWidget(self._ka_range, self.set_ka, "coeficiente de sencibilidad AM", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._AM_range = Range(-4, 4, 0.01, 1, 200)
        ...
        self.Modulador_AM_Erwin_0 = Modulador_AM_Erwin(
            Ac=Ac,
            ka=ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_AM_Erwin_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.Modulador_AM_Erwin_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Modulador_AM_Erwin_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Modulador_AM_Erwin_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_AM_Erwin_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.CALCULODEPOTENCIAJ1C_0, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.Modulador_AM_Erwin_0.set_ka(self.ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_AM_Erwin_0.set_Ac(self.Ac)
...
def main(top_block_cls=generador_amplitud_GNU_radio, options=None):
