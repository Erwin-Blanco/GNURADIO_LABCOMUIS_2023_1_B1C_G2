...
class parte_4_A(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "parte_4_A")
        ...
        self._fcb_win = RangeWidget(self._fcb_range, self.set_fcb, "frecuencia-corte-filtro-pasaba", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_0.set_samp_rate(6.25e6)
...
def main(top_block_cls=parte_4_A, options=None):
