...
class lab1_punto3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "lab1_punto_intermedio ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab1_punto_intermedio ")
        ...
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "frequency", "dial", float, QtCore.Qt.Horizontal)
