...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = Range(1000, 40000, 1000, 5000, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "frequecy", "counter_slider", float, QtCore.Qt.Horizontal)
